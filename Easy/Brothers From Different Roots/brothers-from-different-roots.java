...
class Solution
{
    static void inorder(Node root1,ArrayList<Integer> list)
    {
    ...
    static void mapping(Node root2,HashSet<Integer> hash)
    {
        if(root2==null) return;
        mapping(root2.left,hash);
        hash.add(root2.data);
        mapping(root2.right,hash);
    }
